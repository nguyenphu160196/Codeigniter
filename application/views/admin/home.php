				<div class="col-md-10">				
					...
					<div class="content">
							...
							<h4 class="text-right" style="color: #fff"><?php echo $sumdm ?></h4>
							<p class="text-left"><i class="fa fa-table fa-4x" style="color: #fbdb94" aria-hidden="true"></i></p>
							</div>
							<div class="col-md-4 thongbao cobv">
							<h4 class="text-right" style="color: #fff">Tổng số sản phẩm</h4>
							<h4 class="text-right" style="color: #fff"><?php echo $sumbv ?></h4>
							...
							<h4 class="text-right" style="color: #fff"><?php echo $sumtv ?></h4>
